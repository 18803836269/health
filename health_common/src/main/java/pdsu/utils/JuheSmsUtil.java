...
public class JuheSmsUtil {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="eeac6bd2f4487f3c24131f264bcbb7a9";
    //配置您申请验证码模板
    public static final String VERIFICATION_CODE_TPL = "169170";
    //配置您申请通知模板
    public static final String NOTICE_TPL = "xxxxxx";
